...
namespace DNSCrypt_Proxy\acex86_co_revision {
    ...
    Final Class UFileFix
    {
        ...
        Private Function UFileFix(int $FilePath, int $NewLine): void
        {
        ...
        Final Function __construct(int $FilePath, int $NewLine)
        {
            ...
            $this->UFileFix($FilePath, $NewLine);
        }
    ...
    $Info = '';
    $UFileFix = new UFileFix(1,3) ? $Info = 'Processing done.': $Info = 'Error processing data.';
    $UFileFix = null;
    empty($UFileFix);
    unset($UFileFix);
    echo $Info;
